...
public class HttpDelete extends HttpRequest {
	 ...
	 */
	public HttpDelete(ServletContainter servletContainer, String uri) throws IllegalArgumentException {
	...
	HttpRequestBase getCoreRequest() {
		if (coreRequest == null) {
			coreRequest = new org.apache.http.client.methods.HttpDelete(getUri());
		}
