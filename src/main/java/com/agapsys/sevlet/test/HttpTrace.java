...
public class HttpTrace extends HttpRequest {
	 ...
	 */
	public HttpTrace(ServletContainter servletContainer, String uri) throws IllegalArgumentException {
	...
	HttpRequestBase getCoreRequest() {
		if (coreRequest == null) {
			coreRequest = new org.apache.http.client.methods.HttpTrace(getUri());
		}
