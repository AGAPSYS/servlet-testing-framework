...
public class StringEntityPost extends StringEntityRequest {
	public StringEntityPost(ServletContainer servletContainer, String uri) throws IllegalArgumentException {
