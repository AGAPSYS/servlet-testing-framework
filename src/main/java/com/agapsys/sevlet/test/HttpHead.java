...
public class HttpHead extends HttpRequest {
	...
	public HttpHead(ServletContainter servletContainer, String uri) throws IllegalArgumentException {
	...
	HttpRequestBase getCoreRequest() {
		if (coreRequest == null) {
			coreRequest = new org.apache.http.client.methods.HttpHead(getUri());
		}
